...
export ORILOCAL_CLOUD_REPO=vasabi-1234local_cloud_repo4321-ibasav
export ORILOCAL_CLOUD_REPO_DIR=vasabi-1234localcloudrepodir4321-ibasav
...
#
# Change GATEWAY_INET_NIC 
#
CHANGETOPIC=GATEWAY_INET_NIC
#
printf "\nsubstitution\n"

printf "\n----------\n"
grep -n "${ORIGATEWAY_INET_NIC}" ${ETC_FILES} | tee ./tmpfile ; wc -l ./tmpfile
printf "\n\n${CHANGETOPIC} (in etc files) changed to\n\n"
sed -i "s/${ORIGATEWAY_INET_NIC}/${GATEWAY_INET_NIC}/g" ${ETC_FILES}
grep -n "${GATEWAY_INET_NIC}"  ${ETC_FILES}  | tee ./tmpfile ; wc -l ./tmpfile 
#
printf "\nsubstitution\n"

printf "\n----------\n"
grep -n "${ORIGATEWAY_INET_NIC}" ${SCRIPT_FILES} | tee ./tmpfile ; wc -l ./tmpfile
printf "\n\n${CHANGETOPIC} changed to\n\n"
sed -i "s/${ORIGATEWAY_INET_NIC}/${GATEWAY_INET_NIC}/g" ${SCRIPT_FILES}
grep -n "${GATEWAY_INET_NIC}" ${SCRIPT_FILES}  | tee ./tmpfile ; wc -l ./tmpfile 
#
...
printf "\n----------\n"
grep -n "${ORIGATEWAY_IP_NIC}" ${ETC_FILES} | tee ./tmpfile ; wc -l ./tmpfile
printf "\n\n${CHANGETOPIC} (in etc files) changed to\n\n"
sed -i "s/${ORIGATEWAY_IP_NIC}/${GATEWAY_IP_NIC}/g" ${ETC_FILES}
grep -n "${GATEWAY_IP_NIC}"  ${ETC_FILES}  | tee ./tmpfile ; wc -l ./tmpfile 
#
printf "\nsubstitution\n"

printf "\n----------\n"
grep -n "${ORIGATEWAY_IP_NIC}" ${SCRIPT_FILES} | tee ./tmpfile ; wc -l ./tmpfile
printf "\n\n${CHANGETOPIC} changed to\n\n"
sed -i "s/${ORIGATEWAY_IP_NIC}/${GATEWAY_IP_NIC}/g" ${SCRIPT_FILES}
grep -n "${GATEWAY_IP_NIC}" ${SCRIPT_FILES}  | tee ./tmpfile ; wc -l ./tmpfile 
#
...
printf "\n----------\n"
grep -n "${ORIVPN_IP_RANGE}" ${ETC_FILES} | tee ./tmpfile ; wc -l ./tmpfile
printf "\ngateway ip (in etc files) changed to\n"
sed -i "s/${ORIVPN_IP_RANGE}/${VPN_IP_RANGE}/g" ${ETC_FILES}
grep -n "${VPN_IP_RANGE}" ${ETC_FILES}  | tee ./tmpfile ; wc -l ./tmpfile 
#
...
#
# local cloud repo IP address and Directory in  ${ETC_FILES} and ${SCRIPT_FILES}
#
printf "\nsubstitution\n"

printf "\n----------\n"
grep -n "${ORILOCAL_CLOUD_REPO}" ${ETC_FILES} | tee ./tmpfile ; wc -l ./tmpfile
printf "\nlocal cloud repo ip (in etc files) changed to\n"
sed -i "s/${ORILOCAL_CLOUD_REPO}/${LOCAL_CLOUD_REPO}/g" ${ETC_FILES}
grep -n "${LOCAL_CLOUD_REPO}" ${ETC_FILES}  | tee ./tmpfile ; wc -l ./tmpfile 
#
printf "\nsubstitution\n"

printf "\n----------\n"
grep -n "${ORILOCAL_CLOUD_REPO}" ${SCRIPT_FILES} | tee ./tmpfile ; wc -l ./tmpfile
printf "\nlocal cloud repo ip (in script file) changed to\n"
sed -i "s/${ORILOCAL_CLOUD_REPO}/${LOCAL_CLOUD_REPO}/g" ${SCRIPT_FILES}
grep -n "${LOCAL_CLOUD_REPO}" ${SCRIPT_FILES}  | tee ./tmpfile ; wc -l ./tmpfile 

printf "\nsubstitution\n"
printf "\n----------\n"
grep -n "${ORILOCAL_CLOUD_REPO_DIR}" ${ETC_FILES} | tee ./tmpfile ; wc -l ./tmpfile
printf "\nlocal cloud repo ip (in etc files) changed to\n"
sed -i "s/${ORILOCAL_CLOUD_REPO_DIR}/${LOCAL_CLOUD_REPO_DIR}/g" ${ETC_FILES}
grep -n "${LOCAL_CLOUD_REPO_DIR}" ${ETC_FILES}  | tee ./tmpfile ; wc -l ./tmpfile 
#
printf "\nsubstitution\n"

printf "\n----------\n"
grep -n "${ORILOCAL_CLOUD_REPO_DIR}" ${SCRIPT_FILES} | tee ./tmpfile ; wc -l ./tmpfile
printf "\nlocal cloud repo ip (in script file) changed to\n"
sed -i "s/${ORILOCAL_CLOUD_REPO_DIR}/${LOCAL_CLOUD_REPO_DIR}/g" ${SCRIPT_FILES}
grep -n "${LOCAL_CLOUD_REPO_DIR}" ${SCRIPT_FILES}  | tee ./tmpfile ; wc -l ./tmpfile 
#
